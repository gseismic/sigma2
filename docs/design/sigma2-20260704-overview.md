...
本文已由 `docs/design/sigma2-20260922-v5.md` 替代，仅保留历史追溯价值。后续设计与实施以 v5 总设计为准。

下文记录的是 2026-07 阶段的设计结论，其中 `rSignal`、family、`step()` 和按 family 组织源码等方向仍被 v5 保留；“同周期修订不进入 core”以及扩展 `rPyta2Xxx` 适配类等结论已经被 v5 修正。
